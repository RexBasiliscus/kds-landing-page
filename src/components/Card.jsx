...
const Card = ({ title, image, description, linkText }) => {
  ...
  return (
    <div className="bg-background shadow-md rounded-2xl p-4 sm:p-6 md:p-8 w-full max-w-[320px] sm:max-w-[360px] md:max-w-[400px] lg:max-w-[450px] flex flex-col gap-3 sm:gap-4">
      {/* Title + Image */}
